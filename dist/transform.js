    ...
    function TransformTool() {
        ...
        function onTxChange() {
            ...
            for (var fragId in _selectedFragProxyMap) {
                ...
                var position = new THREE.Vector3(_transformMesh.position.x - fragProxy.offset.x, _transformMesh.position.y - fragProxy.offset.y, _transformMesh.position.z - fragProxy.offset.z);
...
Autodesk.Viewing.theExtensionManager.registerExtension('Autodesk.ADN.Viewing.Extension.TransformTool', Autodesk.ADN.Viewing.Extension.TransformTool);